...
Products::Products(uint32_t width_band, uint32_t height_band)
{
    ...
    this->band_blue = (half *)malloc(band_bytes);
    this->band_green = (half *)malloc(band_bytes);
    this->band_red = (half *)malloc(band_bytes);
    this->band_nir = (half *)malloc(band_bytes);
    this->band_swir1 = (half *)malloc(band_bytes);
    this->band_termal = (half *)malloc(band_bytes);
    this->band_swir2 = (half *)malloc(band_bytes);
    this->tal = (half *)malloc(band_bytes);

    this->radiance_blue = (half *)malloc(band_bytes);
    this->radiance_green = (half *)malloc(band_bytes);
    this->radiance_red = (half *)malloc(band_bytes);
    this->radiance_nir = (half *)malloc(band_bytes);
    this->radiance_swir1 = (half *)malloc(band_bytes);
    this->radiance_termal = (half *)malloc(band_bytes);
    this->radiance_swir2 = (half *)malloc(band_bytes);

    this->reflectance_blue = (half *)malloc(band_bytes);
    this->reflectance_green = (half *)malloc(band_bytes);
    this->reflectance_red = (half *)malloc(band_bytes);
    this->reflectance_nir = (half *)malloc(band_bytes);
    this->reflectance_swir1 = (half *)malloc(band_bytes);
    this->reflectance_termal = (half *)malloc(band_bytes);
    this->reflectance_swir2 = (half *)malloc(band_bytes);

    this->albedo = (half *)malloc(band_bytes);
    this->ndvi = (half *)malloc(band_bytes);
    this->soil_heat = (half *)malloc(band_bytes);
    this->surface_temperature = (half *)malloc(band_bytes);
    this->net_radiation = (half *)malloc(band_bytes);
    this->lai = (half *)malloc(band_bytes);
    this->savi = (half *)malloc(band_bytes);
    this->pai = (half *)malloc(band_bytes);
    this->enb_emissivity = (half *)malloc(band_bytes);
    this->eo_emissivity = (half *)malloc(band_bytes);
    this->ea_emissivity = (half *)malloc(band_bytes);
    this->short_wave_radiation = (half *)malloc(band_bytes);
    this->large_wave_radiation_surface = (half *)malloc(band_bytes);
    this->large_wave_radiation_atmosphere = (half *)malloc(band_bytes);

    this->surface_temperature = (half *)malloc(band_bytes);
    this->d0 = (half *)malloc(band_bytes);
    this->zom = (half *)malloc(band_bytes);
    this->ustar = (half *)malloc(band_bytes);
    this->kb1 = (half *)malloc(band_bytes);
    this->aerodynamic_resistance = (half *)malloc(band_bytes);
    this->sensible_heat_flux = (half *)malloc(band_bytes);

    this->latent_heat_flux = (half *)malloc(band_bytes);
    this->net_radiation_24h = (half *)malloc(band_bytes);
    this->evapotranspiration_24h = (half *)malloc(band_bytes);
